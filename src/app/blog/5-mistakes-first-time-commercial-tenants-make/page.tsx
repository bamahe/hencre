  ...
  return (
    <>
      ...
      <article className="prose-hencre mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">Mistake 1: Only Looking at Base Rent</h2>
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">Mistake 2: Not Understanding the Lease Structure</h2>
        <p className="mt-4 text-slate-brand leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">Mistake 3: Ignoring the Personal Guarantee</h2>
        <p className="mt-4 text-slate-brand leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">Mistake 4: Underestimating Build-Out Costs and Timelines</h2>
        <p className="mt-4 text-slate-brand leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">Mistake 5: Not Having Representation</h2>
        <p className="mt-4 text-slate-brand leading-relaxed">
