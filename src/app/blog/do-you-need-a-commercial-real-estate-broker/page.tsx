  ...
  return (
    <>
      ...
      <article className="prose-hencre mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">What a Commercial Broker Actually Does</h2>
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">When You Definitely Need a Broker</h2>

        <h3 className="mt-6 text-xl font-bold text-navy">You Are a First-Time Commercial Tenant</h3>
        ...
        <h3 className="mt-6 text-xl font-bold text-navy">You Are Buying Investment Property</h3>
        <p className="mt-3 text-slate-brand leading-relaxed">
        ...
        <h3 className="mt-6 text-xl font-bold text-navy">You Are Selling Commercial Property</h3>
        <p className="mt-3 text-slate-brand leading-relaxed">
        ...
        <h3 className="mt-6 text-xl font-bold text-navy">You Are Relocating or Expanding Your Business</h3>
        <p className="mt-3 text-slate-brand leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">The Cost Question: Who Pays the Broker?</h2>
        <p className="mt-4 text-slate-brand leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">When You Might Not Need a Broker</h2>
        <p className="mt-4 text-slate-brand leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">How to Choose the Right Broker</h2>
        <p className="mt-4 text-slate-brand leading-relaxed">
