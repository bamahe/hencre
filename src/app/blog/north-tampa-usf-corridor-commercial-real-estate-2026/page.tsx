  ...
  return (
    <>
      ...
      <article className="prose-hencre mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <p className="mt-4 text-[#666666] leading-relaxed">
          That calculation is changing in 2026, and it is changing because of the simultaneous arrival of three projects of a scale that the corridor has never seen before. The Fletcher District — a 138-acre mixed-use development on a former golf course immediately north of the USF campus — received a $24 million Hillsborough County commitment in March 2026 and is moving from planning to construction. Tampa Rithm, the 100-acre redevelopment of the former University Mall site on Fowler Avenue, is progressing through its phased delivery with 5,000 student beds and a full complement of retail, hospitality, and entertainment planned at build-out. And Moffitt Cancer Center continues to expand its research and clinical enterprise at the southern end of the corridor, creating sustained demand for medical office, lab space, and the service ecosystem around an academic medical center. See our broader <Link href="/blog/tampa-hillsborough-county-commercial-real-estate-2026" className="text-accent underline">Hillsborough County commercial real estate guide</Link> for context on how this corridor fits into the full Tampa market picture.
        </p>
        ...
        <p className="mt-4 text-[#666666] leading-relaxed">
          For comparison, look at what happened to the commercial real estate along Fowler Avenue near the former Sears anchor in the years after that box went dark versus what happened at mixed-use university-adjacent redevelopments in markets like Tempe, Gainesville, and Tallahassee after their comparable projects delivered. Retail rents in the trade area moved 20 to 35 percent higher within three to four years of substantial occupancy being established. That is the market dynamic at play in North Tampa. For more on Tampa Bay's broader retail investment environment, see our <Link href="/blog/tampa-bay-retail-market-q2-2026" className="text-accent underline">Q2 2026 Tampa Bay retail market report</Link>.
        </p>
