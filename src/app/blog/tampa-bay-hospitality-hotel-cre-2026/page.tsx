  ...
  return (
    <>
      ...
      <article className="prose-hencre mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <p className="mt-4 text-[#666666] leading-relaxed">
          Near Water Street, <strong>Hotel ORA</strong> is advancing with strong presales, incorporating a luxury hotel, branded residences, convention facilities, restaurant, and rooftop amenities in a single mixed-use structure. The combination of hotel revenue and residential sellout gives the developer multiple capital recovery paths — a structure that has become increasingly common in markets where luxury hotel development alone cannot justify current land costs. The ongoing buildout of the Water Street district, including the recently announced <Link href="/blog/water-street-tampa-33-story-tower-downtown-cre-2026" className="text-accent underline">33-story mixed-use tower</Link>, reinforces the demand case for hospitality at this location.
        </p>
        <p className="mt-4 text-[#666666] leading-relaxed">
          Across the bay in St. Petersburg, <strong>The Central</strong> project is expected to break ground in 2026 with a 168-key Autograph Collection hotel alongside a 140,000-square-foot office tower — a pairing that reflects the complementary demand between business lodging and professional office tenants who both benefit from walkable urban amenities. Our full analysis of the <Link href="/blog/st-petersburg-commercial-real-estate-2026" className="text-accent underline">St. Petersburg commercial real estate market</Link> covers how this project fits into Pinellas County&apos;s broader trajectory.
        </p>
        ...
        <p className="mt-4 text-[#666666] leading-relaxed">
          Parking structures serving hospitality mixed-use are a related opportunity. Branded hotels generate significant parking demand from both guests and restaurant patrons, and a well-located parking asset in a dense downtown submarket can function as a commercial real estate investment with hotel-grade demand characteristics. For investors evaluating these assets, understanding <Link href="/blog/what-makes-a-good-commercial-investment" className="text-accent underline">what makes a good commercial investment</Link> -- particularly how demand drivers translate to sustainable occupancy and rents -- is essential underwriting discipline.
        </p>
        <p className="mt-4 text-[#666666] leading-relaxed">
          The broader mixed-use retail pattern follows the hospitality pipeline. Our analysis of <Link href="/blog/tampa-mall-redevelopment-mixed-use-2026" className="text-accent underline">Tampa Bay mall redevelopment and mixed-use projects</Link> shows how former retail anchors are being repositioned with hotel components specifically because hotel demand stabilizes mixed-use projects that would struggle on retail alone. If you own commercial property near a planned hotel development or in a submarket where hospitality is concentrating, the lease demand and valuation dynamics have already begun to shift.
        </p>
