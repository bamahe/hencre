  ...
  return (
    <>
      ...
      <article className="prose-hencre mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <p className="mt-4 text-[#666666] leading-relaxed">
          With 23+ years of commercial real estate experience across <Link href="/markets/hillsborough" className="text-accent underline">Hillsborough</Link>, <Link href="/markets/pinellas" className="text-accent underline">Pinellas</Link>, and <Link href="/markets/pasco" className="text-accent underline">Pasco</Link> Counties, I work with investors evaluating commercial acquisitions in Tampa Bay&apos;s OZ-designated neighborhoods — from East Tampa industrial to Ybor City adaptive reuse to the Port corridor. If you are sitting on a capital gain and want to understand whether a Tampa Bay OZ investment fits your strategy, let&apos;s have that conversation before your 180-day window closes.
        </p>
