  ...
  return (
    <>
      ...
      <article className="prose-hencre mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">Population Growth Is Fueling Demand</h2>
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">Business-Friendly Climate — Literally and Figuratively</h2>
        <p className="mt-4 text-slate-brand leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">Infrastructure Investment</h2>
        <p className="mt-4 text-slate-brand leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">Industrial and Logistics Demand</h2>
        <p className="mt-4 text-slate-brand leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">Healthcare and Medical Office Growth</h2>
        <p className="mt-4 text-slate-brand leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">Retail Is Evolving, Not Dying</h2>
        <p className="mt-4 text-slate-brand leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">What This Means for Investors</h2>
        <p className="mt-4 text-slate-brand leading-relaxed">
