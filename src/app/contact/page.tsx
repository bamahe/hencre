...
export const metadata: Metadata = {
  title: "Contact Barrett Henry | Florida Commercial Real Estate",
  description:
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="mx-auto max-w-7xl px-4 pt-4 sm:px-6 lg:px-8">
        <ol className="flex text-sm text-slate-brand">
          ...
          <li className="font-semibold text-navy" aria-current="page">Contact</li>
        </ol>
      </nav>

      <Hero
        title="Get in Touch"
        subtitle="Have a commercial real estate question? Need a broker opinion of value? Ready to make a move? I am here."
      />
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="flex flex-wrap justify-center gap-8">
          <a
            ...
            className="inline-flex items-center gap-3 rounded-lg border border-gray-200 px-6 py-4 text-lg font-semibold text-navy no-underline transition-shadow hover:shadow-md hover:no-underline"
          >
      ...
      <section className="bg-white px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mx-auto mt-3 max-w-xl text-center text-slate-brand">
          ...
          <div className="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {OFFICES.map((office) => (
              <a
                ...
                className="group flex items-start gap-4 rounded-lg border border-gray-200 p-6 no-underline transition-shadow hover:shadow-md hover:no-underline"
              >
                <MapPin className="mt-1 h-6 w-6 shrink-0 text-accent-blue" />
                <div>
                  <p className="text-lg font-bold text-navy group-hover:text-accent-blue">
                    {office.name}
                  </p>
                  <p className="text-sm text-slate-brand">REMAX Collective</p>
                  <p className="text-sm text-slate-brand">{office.address}</p>
                  <p className="text-sm text-slate-brand">{office.city}</p>
                </div>
              </a>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-8 rounded-lg border border-gray-200 bg-white p-8">
            ...
            <p className="mt-4 text-sm text-slate-brand">
              Or call <a href="tel:+18137337907" className="font-semibold text-accent-blue">(813) 733-7907</a> or
              email <a href="mailto:barrett@nowtb.com" className="font-semibold text-accent-blue">barrett@nowtb.com</a> directly.
            </p>
          </div>
        </div>
      </section>
