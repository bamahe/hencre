  ...
  return (
    <>
      ...
      <article className="prose-hencre mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">What CAM Charges Cover</h2>
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">How CAM Charges Are Calculated</h2>
        <p className="mt-4 text-slate-brand leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">What Should NOT Be in Your CAM</h2>
        <p className="mt-4 text-slate-brand leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">How to Negotiate CAM Charges</h2>
        <p className="mt-4 text-slate-brand leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">CAM in Florida Commercial Leases</h2>
        <p className="mt-4 text-slate-brand leading-relaxed">
