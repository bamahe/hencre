  ...
  return (
    <>
      ...
      <article className="prose-hencre mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">Approach 1: The Income Approach</h2>
        ...
        <h3 className="mt-6 text-xl font-bold text-navy">Direct Capitalization</h3>
        ...
        <h3 className="mt-6 text-xl font-bold text-navy">Discounted Cash Flow (DCF)</h3>
        <p className="mt-3 text-slate-brand leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">Approach 2: The Sales Comparison Approach</h2>
        <p className="mt-4 text-slate-brand leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">Approach 3: The Cost Approach</h2>
        <p className="mt-4 text-slate-brand leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">Which Approach Should You Use?</h2>
        <p className="mt-4 text-slate-brand leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold text-navy">When to Get a Formal Appraisal</h2>
        <p className="mt-4 text-slate-brand leading-relaxed">
