...
export const metadata: Metadata = {
  title: "Citrus County Commercial Real Estate — Crystal River & Inverness",
  description:
  ...
  openGraph: {
    title: "Citrus County Commercial Real Estate | HenCRE",
    description:
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: "Citrus County", href: "/markets/citrus" },
        ]}
      />
