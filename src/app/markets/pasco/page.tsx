...
export const metadata: Metadata = {
  title: "Pasco County Commercial Real Estate — Wesley Chapel & New Port Richey",
  description:
  ...
  openGraph: {
    title: "Pasco County Commercial Real Estate | HenCRE",
    description:
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: "Pasco County", href: "/markets/pasco" },
        ]}
      />
