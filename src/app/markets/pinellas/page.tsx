  ...
  "@graph": [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Pinellas County", item: "https://hencre.com/markets/pinellas" },
      ],
    },
    {
      "@type": "LocalBusiness",
...
export default function PinellasMarketPage() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Home", href: "/" }, { label: "Markets", href: "/markets" }, { label: "Pinellas County", href: "/markets/pinellas" }]} />
