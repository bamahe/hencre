...
export const metadata: Metadata = {
  title: "Sarasota County Commercial Real Estate — Sarasota CRE Market",
  description:
  ...
  openGraph: {
    title: "Sarasota County Commercial Real Estate | HenCRE",
    description:
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: "Sarasota County", href: "/markets/sarasota" },
        ]}
      />
