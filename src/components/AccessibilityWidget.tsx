  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-20 left-4 md:bottom-4 z-40 flex h-10 w-10 items-center justify-center rounded-full shadow-lg hover:scale-110 transition-transform focus-visible:ring-2 focus-visible:ring-blue-500 overflow-hidden"
      >
